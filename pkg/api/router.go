...
func SetupRouter() *mux.Router {
	...
	utils.SetRoute(router, "PUT", "/api/dish/prepared", chef.VerifyPreparedDish, userMid.AuthVerifyUser, chefMid.DBGetUserRole, chefMid.AuthVerifyChef, chef.DBSetPreparedDish)
	utils.SetRoute(router, "PUT", "/api/dish/count", user.VerifyCountDish, userMid.AuthVerifyUser, user.DBSetCountDish)
